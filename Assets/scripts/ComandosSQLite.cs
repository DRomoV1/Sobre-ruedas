...
public class ComandosSQLite : MonoBehaviour
{
    ...
    string DBFileName = "On_Wheels.db";
    //Variable texto UI
    //public Text myText;
    ...
    //    }
    //}
    public static ComandosSQLite sharedInstance;
    private void Awake()
    {
    ...
    void ComandoSelect(string item, string tabla)
    {
        ...
        while (reader.Read())
        {
            try
            {
                Debug.Log("Monedas: " + reader.GetInt32(0));
            }
    ...
    public void pickCoin()
    {
        ...
        // Crear la consulta
        dbCommand = dbConnection.CreateCommand();
        string sqlQuery = "UPDATE Sobre_Ruedas SET Monedas = Monedas + 1";
        dbCommand.CommandText = sqlQuery;
        //Para poder contar datos de las filas tenemos que poner
        dbCommand.ExecuteScalar();
        //ExecuteScalar me devuelve un objeto 
        dbCommand = dbConnection.CreateCommand();
        string sqlQuery2 = "SELECT Monedas FROM Sobre_Ruedas";
